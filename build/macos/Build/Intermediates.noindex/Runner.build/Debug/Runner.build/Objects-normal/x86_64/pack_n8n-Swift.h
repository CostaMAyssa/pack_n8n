...
#ifndef PACK_N8N_SWIFT_H
#define PACK_N8N_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pack_n8n",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8pack_n8n11AppDelegate")
...
SWIFT_CLASS("_TtC8pack_n8n17MainFlutterWindow")
